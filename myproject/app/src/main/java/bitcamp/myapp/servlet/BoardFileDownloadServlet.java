...
public class BoardFileDownloadServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            //응답해더를 통해 클라이언트에 보내는 파일의 이름을 알려준다.
            //그러면 웹 브라우저는 이 이름으로 다운로드 할 수 있게 다운로드 창을 띄운다.
            ...
            storageService.download("board/" + attachedFile.getFilename(), // 스토리지 서비스의 버킷에서 다운로귿 할 파일의 경로
                    resp.getOutputStream()); // 다운로드
