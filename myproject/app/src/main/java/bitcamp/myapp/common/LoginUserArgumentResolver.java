...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    // 페이지 컨트롤어의 request handler를 호출 할 때,
    // DispatcherServlet(프로트 컨트롤러)sms request handler가  요구하는 파라미터 값을 주입해 준다.
    ...
    public Object resolveArgument(MethodParameter parameter,
        ...
        System.out.println("safsadfdasfasfsafdds"+member);
        return JwtAuth.extractUserInfo();
    }
}
